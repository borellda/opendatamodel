 ...
 */
@Entity
@javax.persistence.Table(name = "resource_revision", schema = "public", catalog = "ecodp")
public class ResourceRevisionEntity {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(ResourceRevisionEntity.class);
    private String id;
    ...
    @Id
    @javax.persistence.Column(name = "revision_id", nullable = false, length = -1)
    ...
    @Basic
    @javax.persistence.Column(name = "continuity_id", nullable = true, length = -1)
    ...
    @Basic
    @javax.persistence.Column(name = "expired_id", nullable = true, length = -1)
    ...
    @Basic
    @javax.persistence.Column(name = "revision_timestamp", nullable = true)
    ...
    @Basic
    @javax.persistence.Column(name = "expired_timestamp", nullable = true)
    ...
    @Basic
    @javax.persistence.Column(name = "current", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        ResourceRevisionEntity that = (ResourceRevisionEntity) o;
