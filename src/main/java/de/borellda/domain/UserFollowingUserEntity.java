 ...
 */
@Entity
@Table(name = "user_following_user", schema = "public", catalog = "ecodp")
@IdClass(UserFollowingUserEntityPK.class)
public class UserFollowingUserEntity {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(UserFollowingUserEntity.class);
    ...
    public boolean equals(Object o) {
        ...
        UserFollowingUserEntity that = (UserFollowingUserEntity) o;
