 ...
 */
public class GroupRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(GroupRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GroupRevisionEntityPK that = (GroupRevisionEntityPK) o;
