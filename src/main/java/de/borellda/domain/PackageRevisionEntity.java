 ...
 */
@Entity
@javax.persistence.Table(name = "package_revision", schema = "public", catalog = "ecodp")
public class PackageRevisionEntity {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(PackageRevisionEntity.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        PackageRevisionEntity that = (PackageRevisionEntity) o;
