 ...
 */
public class GroupExtraRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(GroupExtraRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GroupExtraRevisionEntityPK that = (GroupExtraRevisionEntityPK) o;
