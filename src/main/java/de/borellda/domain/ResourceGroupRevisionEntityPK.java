 ...
 */
public class ResourceGroupRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(ResourceGroupRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        ResourceGroupRevisionEntityPK that = (ResourceGroupRevisionEntityPK) o;
