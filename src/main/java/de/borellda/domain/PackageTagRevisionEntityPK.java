 ...
 */
public class PackageTagRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(PackageTagRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        PackageTagRevisionEntityPK that = (PackageTagRevisionEntityPK) o;
