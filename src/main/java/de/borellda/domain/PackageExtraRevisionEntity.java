 ...
 */
@Entity
@Table(name = "package_extra_revision", schema = "public", catalog = "ecodp")
@IdClass(PackageExtraRevisionEntityPK.class)
public class PackageExtraRevisionEntity {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(PackageExtraRevisionEntity.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        PackageExtraRevisionEntity that = (PackageExtraRevisionEntity) o;
