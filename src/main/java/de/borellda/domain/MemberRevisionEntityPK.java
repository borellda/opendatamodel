 ...
 */
public class MemberRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(MemberRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        MemberRevisionEntityPK that = (MemberRevisionEntityPK) o;
