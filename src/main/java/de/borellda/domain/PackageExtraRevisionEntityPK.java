 ...
 */
public class PackageExtraRevisionEntityPK implements Serializable {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(PackageExtraRevisionEntityPK.class);
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        PackageExtraRevisionEntityPK that = (PackageExtraRevisionEntityPK) o;
