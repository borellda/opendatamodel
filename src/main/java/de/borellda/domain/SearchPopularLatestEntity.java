 ...
 */
@Entity
@Table(name = "search_popular_latest", schema = "public", catalog = "ecodp")
public class SearchPopularLatestEntity {
    /* The Logger */
    private static final Logger log = LoggerFactory.getLogger(SearchPopularLatestEntity.class);
    private String lang;
    ...
    public boolean equals(Object o) {
        ...
        SearchPopularLatestEntity that = (SearchPopularLatestEntity) o;
